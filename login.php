...
<html>
<head>
<title>Plastic Recycling - web App | Login :: w3layouts</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta property="og:title" content="Vide" />
<meta name="keywords" content="Plastic Recyle Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
if(isset($_POST['login'])){
	...
	$password = $_POST['password'];
		...
		if(mysqli_num_rows($result) > 0)
			{
				$_SESSION['c_f_name']=$num['name'];
					$_SESSION['c_email']=$email;
			$_SESSION['c_id']=$num['user_id'];
